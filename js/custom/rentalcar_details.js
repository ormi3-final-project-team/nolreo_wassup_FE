...
.then(car_datas => {
    console.log('car_datas', car_datas);
...
.then(datas => {
    console.log(typeof datas.car_image, datas.car_image);
    let car_image = [];
    car_image.push(datas['car_image']);
    car_image.forEach(image => { 
...
//         if (pick_list.includes(lodging_id)){
...
//             }).then((res) => {
//                 if (res.status === 201) {
//                     console.log('찜을 성공했습니다.');
//                     pick_list.push(lodging_id);
//                     heartButton.style.fill = 'red';
//                 } else {
//                     console.log('찜을 실패하였습니다.');
//                 }
//             });
//         }
//     }
