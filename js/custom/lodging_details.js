...
.then(datas => {
    ...
    fetch(url + `lodging/roomtype/?lodging_id=1`, {
        method: 'GET',
        headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${access_token}`
    ...
    fetch(url + `lodging/review/?lodging_id=1`, {
        method: 'GET',
        headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${access_token}`
            ...
            if (data['image']){
                ...
                <div class="comment-list review_container">
                    <article class="comment-item pb-3 row">
                        <div class="col-md-1"> 
                            <img src="${url + data['image']}" alt="default" heigth="50" width="50"
                        ...
                        <div class="col-md-10">
                            <div class="author-post mb-4">
                                ...
                                <img src="${url + data['review_images']}">
                                <p>${data['content']}</p>
                                <div class="comments-container${data['comments'][0]['lodging_review']}">
                                </div>
                                <div class="comments-reply border-animation">
                                    <div class="reply-form-container" style="display: none;">
                                        <form class="reply-form">
                                            <textarea class="reply-text" placeholder="댓글을 입력해 주세요."></textarea>
                ...
                const $comment_container = document.querySelector(`.comments-container${data['comments'][0]['lodging_review']}`);
                ...
                document.querySelectorAll('.reply-btn').forEach(btn => {
                    btn.addEventListener('click', (e) => {
                        e.preventDefault();
                        const formContainer = e.target.closest('.comment-item').querySelector('.reply-form-container');
                ...
                <div class="comment-list review_container">
                    <article class="comment-item pb-3 row">
                        <div class="col-md-1"> 
                            <svg xmlns="http://www.w3.org/2000/svg" height="50" width="50" viewBox="0 0 448 512" class="commentor-image img-fluid rounded-circle"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2023 Fonticons, Inc.--><path d="M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm-45.7 48C79.8 304 0 383.8 0 482.3C0 498.7 13.3 512 29.7 512H418.3c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304H178.3z"/></svg>
                        </div>
                        <div class="col-md-10">
                            <div class="author-post mb-4">
                                <div class="comment-meta mb-2 text-capitalize d-flex gap-3 text-black">
